    ...
    <div class="card-body">
      ...
      <form class="form-horizontal" action="./index.php?aksi=Master&xaksi=artikel&yaksi=6" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" value="<?php echo $row['category']; ?>" id="category" name="category">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
             <textarea class="form-control editor" value="<?php echo $row['isi_artikel']; ?>" id="isi_artikel" name="isi_artikel"></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <img src="../images/artikel/<?php echo $row['gambar']; ?>" alt="Image" width="200">
